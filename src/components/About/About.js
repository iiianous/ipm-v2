...
const SectionAbout = () => {
	return (
		<Container>
			...
			<Text>
				I'm Ian Mostar, based in Cebu, Philippines. I have been working in web
				development for 5 years. The first 2 years, I mostly work as a web &
				mobile UI designer. I've transitioned more into a front-end developer
				...
				<br />
				<br />
				I create frontend experiences using Vue.js/Vuex, React.js/Redux,
				Javascript, TailwindCSS, CSS3/SCSS/HTML5.
				<br />
				<br />
				You'll find me on{" "}
				<a
				...
				, hot-picking design and web development posts around.
			</Text>
		</Container>
	);
};
